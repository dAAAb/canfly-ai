...
最後掃描：2026-09-25（每日選題掃描，06:00 Taipei）
...
| `google-gemini` | 更新 CLI → Antigravity，不要另開 Gemini 頁。Omni 1.1 Flash、3.8 Flash、3.8 Live、3.8 Flash TTS 也寫這頁 |
| `nemotron-3-super` | 不要改寫成 Lightning；加家族連結 |
| `openclaw` | 更新成 2.0（v2026.8.1）＋穩定補丁 v2026.8.2＋v2026.9.1＋v2026.9.2＋v2026.9.3＋v2026.9.4＋v2026.9.5＋v2026.9.6＋星數（約 390K／390,410）＋custodian，不要重開 2.0／8.2／9.1／9.2／9.3／9.4／9.5／9.6 頁。Astra 另開模型頁。GPT-Live 1 折進 Talk 一句，不要另開語音頁。Gemini 3.8 Live 折進 voice-call 一句。Grok 4.7／GPT-6 Sol／Luna／Opus 5.5 各一句，不要另開 |
