...
/** POST — create a bridge mapping */
export const onRequestPost: PagesFunction<Env & { BRIDGE_MODE?: string }> = async ({ env, request }) => {
...
/** GET — list or lookup bridge mappings */
export const onRequestGet: PagesFunction<Env> = async ({ env, request }) => {
  ...
  // Single lookup by CanFly task ID
  if (taskId) {
