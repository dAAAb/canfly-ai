      ...
      <div className="relative z-10 flex flex-col h-full px-[5.2%] pt-[4%] pb-[3%]">
        ...
        <div className="flex-1 flex flex-col items-center justify-center" style={{ marginTop: '-3%' }}>
          <h1
            ...
            style={{ fontSize: 'clamp(36px, 7vw, 120px)', letterSpacing: '-0.02em', lineHeight: 1.05 }}
          >
            Now You Can
            <br />
          ...
          <p
            ...
            style={{ fontSize: 'clamp(16px, 2vw, 40px)', opacity: 0.9 }}
          >
            AI Agent 時代的起飛平台
          </p>
          ...
          <p
            ...
            style={{ fontSize: 'clamp(13px, 1.2vw, 22px)', opacity: 0.6 }}
          >
            by 寶博士 JC Ko
          </p>
        </div>
        ...
        {/* Footer */}
        <div className="text-center" style={{ fontSize: 'clamp(12px, 1.05vw, 20px)', opacity: 0.6 }}>
          2026
        </div>
      </div>
    </div>
