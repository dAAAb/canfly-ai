...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'HDMI Dummy Plug',
    tagline: 'Essential for headless AI servers',
    category: 'hardware',
    price: '$8-16',
    status: 'available',
    description: 'Running a headless AI server (Mac Mini, mini PC, Raspberry Pi)? An HDMI dummy plug tricks your computer into thinking a monitor is connected, enabling full GPU acceleration and remote desktop. A must-have for any always-on AI setup.',
    features: [
      '4K@60Hz display emulation',
      ...
      'Under $10 for single, $16 for 6-pack',
    ],
    screenshots: [],
    tutorial: '/learn/hardware',
    affiliateLink: 'https://www.amazon.com/s?k=HDMI+dummy+plug+4K&tag=juchunko-20',
    affiliateCode: 'juchunko-20',
    commission: 'Amazon Associates',
    cta: {
      primary: 'Buy on Amazon',
      primaryLink: 'https://www.amazon.com/s?k=HDMI+dummy+plug+4K&tag=juchunko-20',
      secondary: 'Hardware Guide',
      secondaryLink: '/learn/hardware',
    },
  },
