...
const categoryFeatured: Record<string, string[]> = {
  ...
  skills: ['heygen', 'elevenlabs', 'firecrawl'],
...
const featuredGradients: Record<string, string> = {
  ...
  firecrawl: 'bg-gradient-to-br from-orange-950/60 to-amber-950/40 border border-orange-800/30 hover:border-orange-700/50',
}
...
export default function AppsPage() {
  ...
  const validCategories = ['all', 'free', 'vm', 'skills', 'hosting', 'hardware', 'models']
  useEffect(() => {
